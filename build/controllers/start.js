...
async function keyboardlist(ctx, page, searchTerm, threadid) {
...
botComposer.on("callback_query:data", async (ctx) => {
    try {
        ...
        const searchTerm = extractSearchTerm(ctx.update.callback_query.message.text);
...
botComposer.on(":file", (ctx) => {
    ...
    if (ctx.msg.document) {
        ...
        const data = {
            userid: (_a = ctx.msg.from) === null || _a === void 0 ? void 0 : _a.id,
            first_name: (_b = ctx.msg.from) === null || _b === void 0 ? void 0 : _b.first_name,
        ...
        const data = {
            userid: (_c = ctx.msg.from) === null || _c === void 0 ? void 0 : _c.id,
            first_name: (_d = ctx.msg.from) === null || _d === void 0 ? void 0 : _d.first_name,
